...
public class VerificadordeCpf {
	...
	public static void main(String[] args) {
		...
		System.out.print("\t\t\t<----------SEJA BEM VINDO AO VERIFICADOR DE CPF---------->"+"\nDigite o seu cpf Com .e- EX:100.200.300-90"+"\n\nDigite o CPF:");
		cpf = teclado.next();
		...
		if(confere.equals(cpf)) {
			System.out.print("\t\t\t<----------O seu cpf esta correto---------->");
		}else {
			System.out.print("\n\nO seu cpf esta Incorreto " + cpf + "\n\nO correto seria " + confere);
		}
